...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=100431&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed155blkzgtxiv&vp_template=6130&subId=[SUBID_ENCODED]&cbuster=1632062266',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Ubuntu","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Firefox","browserType":"browser","browserVersion":"87.0","browserVersionMajor":"87","browserVersionMinor":"0","chromeVersion":""},"browser":"firefox","os":"linux","osVer":"","deviceType":"desktop","languages":["en"]},
					isFpCookie: 1,
					geo: 'XX',
					dmaCode: 0,
					dynamicSetup: [],
