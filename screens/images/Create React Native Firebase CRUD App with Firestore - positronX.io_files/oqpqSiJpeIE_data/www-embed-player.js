...
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Em;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Ha}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
{objectStoreNames:c,
dbName:b});if("AbortError"===e.name)return new Q("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},e.message);e.args=[{name:"IdbError",Bm:e.name,dbName:b,objectStoreNames:c}];e.level="WARNING";return e}
...
wa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Sk={W:[],S:[{Pa:Rk,weight:500}]};function Rk(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
Vk();c=u(a.W);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Am)){a=d.weight;break a}a=u(a.S);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Pa(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Qk);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.wa[l.name])for(e=u(c.wa[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
...
{parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()}:h&&hl(new wi("newScreen() parent element does not have a VE - rootVe",b));l&&(r.cloneCsn=l);l={cttAuthInfo:n,Z:q};k?Jh("screenCreated",r,k,l):Pk("screenCreated",r,l);ii(li,new Rl(q));var p=q}catch(A){jl(A,{Dm:b,rootVe:d,parentVisualElement:void 0,ym:e,Cm:f,Sa:c.Sa});il(A);return}Ql(p,b,c.layer,c.cttAuthInfo);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=O("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(Fl));for(f=b.next();!f.done;f=
